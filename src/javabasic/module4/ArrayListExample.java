...
//Создать проект на базе одного класса, содержащего как описание методов, так и главный запускающий класс. В данном классе инициализировать и заполнить  массив из восьми имен любимых актеров.
// Создать также списочный массив из элементов типа String. Написать private метод, реализующий последовательное добавление элементов из массива в списочный массив. Вывести в консоль список элементов массива.
// Добавить два новых имени в позиции 2 и 5 списочного массива , вывести весь списочный массив в консоль. Написать метод, выводящий в консоль количество элементов в массиве и количество элементов в списочном массиве.
// Написать метод выводящий номер позиции элемента в списочном массиве по его имени. Написать метод, удаляющий элемент из списочного массива по указанному  имени.
// Написать метод удаляющий элемент из списочного массива по указанной позиции.
