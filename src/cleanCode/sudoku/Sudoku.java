...
public class Sudoku {
    ...
    private static final int FIRST_SECTOR_START = 0;
    private static final int MIDDLE_SECTOR_START = 3;
    private static final int lAST_SECTOR_START = 6;
    ...
    private void initTableCellsFromInput() {
        ...
        forEachCell((i, j) -> {
            ...
            if (c == ' ') {
                table[i][j] = 0;
            } else if (Character.getNumericValue(c) <= MAX_DIGIT && Character.getNumericValue(c) >= 0) {
    ...
    private void forEachCellInSector(int str, int col, BiConsumer<Integer, Integer> consumer) {
